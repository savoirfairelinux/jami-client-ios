...
Read before any push / notification / connection / sync work.

Required scope check: do not treat the iOS client as the boundary. Inspect the
relevant daemon source under `daemon/`, dhtnet and opendht source under `daemon/contrib`.
