...
/// through the `StoredContact` msgpack mirror shared with the notification
...
final class ContactsFormatTests: JamiBaseOneAccountUITest {
    ...
    func testContactsFileDecodesThroughStoredContact() throws {
        ...
        XCTAssertEqual(result, "PASS", "StoredContact format check failed: \(result)")
    }
}
