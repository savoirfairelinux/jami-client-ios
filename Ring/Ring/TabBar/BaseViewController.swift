...
public enum TabBarItemType {
    ...
    var tabBarItem: UITabBarItem {
        ...
        case .account:
            return UITabBarItem(title: L10n.Global.meTabBarTitle, image: UIImage(named: "conversation_icon"), selectedImage: UIImage(named: "account_icon"))
        case .contactRequest:
            return UITabBarItem(title: L10n.Global.contactRequestsTabBarTitle, image: UIImage(named: "conversation_icon"), selectedImage: UIImage(named: "contact_request_icon"))
        }
    }
}
