...
class GeneralSettingsViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    func makeAcceptTransferLimitCell() -> DisposableCell {
        ...
        label.text = L10n.GeneralSettings.FileTransfer.acceptTransferLimit
        ...
        textField.placeholder = "in MB, 0 = unlimited"
        ...
        textField.rx.value
            ...
            .subscribe(onNext: { [weak self] (newValue) in
                self?.viewModel.changeTransferLimit(value: Int(newValue ?? "20") ?? 20)
            })
            .disposed(by: cell.disposeBag)
        return cell
    }
