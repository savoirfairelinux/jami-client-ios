...
// Every NSManagedObject should inherit this to be usable by Table<T> class
...
class CDManager {
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Ring.sqlite")
