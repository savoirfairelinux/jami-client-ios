...
class SmartlistViewController: UIViewController, UITableViewDelegate {
    ...
    func setupTableView() {
        ...
        self.viewModel.conversationsObservable.asObservable().bindTo(tableView.rx.items(cellIdentifier: "ConversationCellId", cellType: ConversationCell.self) ) { index, viewModel, cell in
