...
class SwarmInfo {
    ...
    lazy var finalAvatar: Observable<UIImage> = {
        return Observable
            .combineLatest(self.avatar.asObservable(), self.participantsAvatars.asObservable()) { (avatar: UIImage?, avatars: [UIImage]) -> UIImage in
    ...
    private func insertParticipant(list: inout BehaviorRelay<[ParticipantInfo]>, jamiId: String, role: ParticipantRole) {
    ...
    private func insertAndSort(list: inout BehaviorRelay<[ParticipantInfo]>, participant: ParticipantInfo) {
