...
final class DBContainer {
    ...
    private func dbExist(accountId: String) -> Bool {
    ...
    func contactProfilePath(accountId: String, profileURI: String, createifNotExists: Bool) -> String? {
        let profilesFolder = contactsPath(accountId: accountId, createIfNotExists: createifNotExists)
    ...
    func needMigrateToDbVersion2(for accountId: String) -> Bool {
        if !dbExist(accountId: accountId) { return true }
    ...
    func removeContacts(accountId: String) {
        let contacts = self.contactsPath(accountId: accountId, createIfNotExists: false)
        let fileManager = FileManager.default
        do {
    ...
    func removeAccountFolder(accountId: String) {
        let account = self.accountFolderPath(accountId: accountId)
        let fileManager = FileManager.default
        do {
