...
class DBManager {
    ...
    func provisionalProfile(for profileUri: String, accountId: String) -> Profile? {
        dbConnections.provisionalProfile(accountId: accountId, profileURI: profileUri)
    }

    @discardableResult
    func saveProvisionalProfile(_ profile: Profile, accountId: String) -> Bool {
        dbConnections.saveProvisionalProfile(profile, accountId: accountId)
    }

    func removeProvisionalProfile(for profileUri: String, accountId: String) {
        dbConnections.removeProvisionalProfile(accountId: accountId, profileURI: profileUri)
    }
