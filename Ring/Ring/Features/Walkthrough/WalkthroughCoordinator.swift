...
class WalkthroughCoordinator: Coordinator, StateableResponsive {
    ...
    var presentedController: WelcomeViewController?
    ...
    required init (with injectionBag: InjectionBag) {
        ...
        self.stateSubject
            .subscribe(onNext: { [weak self] (state) in
                ...
                case .walkthroughCanceled:
                    self.presentedController?.viewModel = nil
    ...
    func start () {
        presentedController = WelcomeViewController.instantiate(with: self.injectionBag)
