...
struct ProfileView: View {
    ...
    init(isPresented: Binding<Bool>, initialName: String, initialImage: Binding<UIImage?>, saveProfile: @escaping (String, UIImage?) -> Void) {
    ...
    @SwiftUI.State private var defaultImage: UIImage = UIImage(systemName: "person")!
    ...
    var body: some View {
        NavigationView {
            VStack(alignment: .center) {
                ...
                TextField(L10n.AccountPage.profileNamePlaceholder, text: $profileName)
                    .padding()
