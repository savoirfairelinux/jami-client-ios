            ...
            switch item {
                ...
                case .jamsAccount:
                    JamsConnectView(dismissAction: {
                        ...
                        activeView = nil
                        guard let model = model else { return }
                        model.connectToAccountManager(userName: username, password: password, server: server)
                    })
                case .sipAccount:
                    SIPConfigurationView(dismissAction: {
                        ...
                        activeView = nil
                        guard let model = model else { return }
                        model.createSipAccount(userName: username, password: password, server: server)
                    })
                case .aboutJami:
                    AboutSwiftUIView()
            }
