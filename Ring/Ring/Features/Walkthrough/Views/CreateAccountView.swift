...
struct CreateAccountView: View {
    ...
    init(injectionBag: InjectionBag, dismissAction: @escaping () -> Void, createAction: @escaping (String, String, String, UIImage?) -> Void) {
        ...
        ZStack {
            VStack {
                ...
                .sheet(isPresented: $showProfileView) {
                    ProfileView(isPresented: $showProfileView, initialName: profileName, initialImage: $profileImage) { (name, photo) in
    ...
    private var userNameView: some View {
        CreateAccountFocusableTextEditView(text: $name, isTextFieldFocused: $isTextFieldFocused, placeholder: L10n.Global.username, identifier: AccessibilityIdentifiers.usernameTextField)
    }
    ...
    private var encryptButton: some View {
        Button(action: {
            ...
            Text(encryptionEnabled ? L10n.AccountPage.changePassword : L10n.CreateAccount.encrypt)
