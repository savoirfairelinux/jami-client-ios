...
class CreateAccountViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    override func viewDidLoad() {
        ...
        self.joinButton.titleLabel?.textColor = .jamiButtonDark
    ...
    private func bindViewToViewModel() {
        ...
        usernameTextField.rx.text
            .map { text in
                // Return true if the text is nil or empty
                return text?.isEmpty ?? true
            }
            .bind(to: viewModel.registerUsername)
            .disposed(by: disposeBag) // Assuming you have a disposeBag defined
