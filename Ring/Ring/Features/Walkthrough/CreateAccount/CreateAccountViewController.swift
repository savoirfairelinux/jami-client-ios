    ...
    func setContentInset() {
        ...
        default :
            //self.scrollView.contentInset.bottom = 90 + self.registerUsernameHeightConstraint.constant + self.choosePasswordViewHeightConstraint.constant
                        self.scrollView.contentInset.bottom =  self.registerUsernameHeightConstraint.constant + self.choosePasswordViewHeightConstraint.constant + self.keyboardHeight / 2.5
//            self.scrollView.contentInset.bottom =  self.registerUsernameHeightConstraint.constant + self.choosePasswordViewHeightConstraint.constant + UIScreen.main.bounds.height / 6
        }
    }
    ...
    @objc func keyboardWillAppear(withNotification: NSNotification){
        ...
        let userInfo: Dictionary = withNotification.userInfo!
