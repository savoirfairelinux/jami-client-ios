...
/// Outer shell that observes the overlay state; the actual content lives in
    ...
    private var dismissDragGesture: some Gesture {
        DragGesture()
            .onChanged { value in
                ...
                overlayState.dragOffset = translation
                let progress = min(abs(translation) / dismissThreshold, 1.0)
                overlayState.backgroundAlpha = Double(1.0 - progress * 0.6)
            ...
            .onEnded { value in
                ...
                if shouldDismiss {
                    ...
                    withAnimation(.spring(response: 0.35, dampingFraction: 0.8)) {
                        ...
                        overlayState.backgroundAlpha = 1
                    }
                }
            }
    }
