...
class InvitationViewModel: ViewModel {
    ...
    func acceptRequest() {
        self.conversationsService.acceptConversationRequest(conversationId: self.conversationId, accountId: self.accountId)
    }

    func refuseRequest() {
        self.conversationsService.declineConversationRequest(conversationId: self.conversationId, accountId: self.accountId)
    }
