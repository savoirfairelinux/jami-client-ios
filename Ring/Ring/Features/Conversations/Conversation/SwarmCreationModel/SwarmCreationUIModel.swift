...
class SwarmCreationUIModel: ObservableObject {
    ...
    var swarmCreated: ((_ conversationId: String) -> Void)
    ...
    required init(with injectionBag: InjectionBag, accountId: String, strSearchText: BehaviorRelay<String>, swarmCreated: @escaping ((String) -> Void)) {
    ...
    func createTheSwarm() {
        ...
        _ = self.swarmCreated(conversationId)
    }
