...
class MessageViewModel: Identifiable {
    ...
    var shouldShowTimeString: Bool = false {
        didSet {
            self.messageSwiftUI.timeString = shouldShowTimeString ? MessageViewModel.getTimeLabelString(forTime: self.receivedDate) : ""
    ...
    init(withInjectionBag injectionBag: InjectionBag,
        ...
        self.messageSwiftUI.player = self.player
