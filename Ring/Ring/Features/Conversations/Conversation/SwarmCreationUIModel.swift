...
class SwarmCreationUIModel: ObservableObject {
    ...
    @SwiftUI.State var swarmName: String = ""
    @SwiftUI.State var swarmDescription: String = ""
    @SwiftUI.State var imageData: Data = (UIImage(asset: Asset.addAvatar)?.convertToData(ofMaxSize: 1))!
