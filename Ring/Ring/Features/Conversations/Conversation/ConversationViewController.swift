...
//        self.currentCallButton.isHidden = !self.viewModel.haveCurrentCall()
//              self.currentCallLabel.isHidden = !self.viewModel.haveCurrentCall()
//        self.callButtonHeightConstraint.constant = self.viewModel.haveCurrentCall() ? 60 : 0
