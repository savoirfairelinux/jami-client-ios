...
//    }
    ...
    required init(with injectionBag: InjectionBag) {
        ...
        self.avatarProvider.subscribeAvatar(observable: self.profileImageData.asObservable())
        self.avatarProvider.subscribeProfileName(observable: self.displayName.asObservable())
        self.avatarProvider.subscribeRegisteredName(observable: self.userName.asObservable())
