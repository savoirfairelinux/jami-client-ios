...
struct LocationSharingView: View {
            ...
            ZStack(alignment: model.locationSharingiewModel.isMapOpened ? .center : .bottom) {
                VStack(spacing: 0) {
                    ...
                    ZStack(alignment: .bottom) {
                        MapView(viewModel: model.locationSharingiewModel.mapViewModel, annotations: $model.coordinates, showZoomButton: $model.locationSharingiewModel.isMapOpened)
    ...
    func updateMapViewWithAnimation(isMapOpened: Bool) {
        model.locationSharingiewModel.updateMapViewWithAnimation(isMapOpened: isMapOpened)
    }
