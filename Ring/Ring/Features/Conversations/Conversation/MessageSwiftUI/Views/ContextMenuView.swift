...
//                })
            ...
            if isShortMsg {
                HStack {
                    Spacer()
                        .frame(maxWidth: isOurMsg ? screenWidth : margSize)
                    makeEmojiSelector()
                    ...
                    Spacer()
                        .frame(maxWidth: isOurMsg ? margSize : screenWidth)
                }
