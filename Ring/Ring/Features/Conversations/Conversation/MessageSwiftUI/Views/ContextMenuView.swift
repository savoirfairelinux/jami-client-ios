                ...
                VStack(alignment: .leading) {
                    ...
                    ZStack {
                        model.presentingMessage
                            ...
                            .scaleEffect(messageScale, anchor: .bottomTrailing)
                            .shadow(color: Color(UIColor.tertiaryLabel), radius: messageShadow)
                            .frame(
                    ...
                    makeActions()
                        ...
                        .scaleEffect(actionsScale, anchor: UnitPoint(x: 1, y: 0))
                        .offset(
                            x: model.menuOffsetX,
                            y: model.menuOffsetY
                        )
