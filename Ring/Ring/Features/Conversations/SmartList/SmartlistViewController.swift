...
class SmartlistViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    private func showBlockContactConfirmation(atIndex: IndexPath) {
        let alert = UIAlertController(title: "Block Contact", message: "Are you sure you want to block this contact? (The conversation history with this contact will also be removed)", preferredStyle: .alert)
