...
class SmartlistViewController: UIViewController, StoryboardBased, ViewModelBased, UISearchControllerDelegate {
    ...
    func animateNewConversationStackView(shouldAppear: Bool) {
    ...
    func willDismissSearchController(_ searchController: UISearchController) {
        ...
        self.animateNewConversationStackView(shouldAppear: false)
    }

    func willPresentSearchController(_ searchController: UISearchController) {
        self.animateNewConversationStackView(shouldAppear: true)
    }
}
