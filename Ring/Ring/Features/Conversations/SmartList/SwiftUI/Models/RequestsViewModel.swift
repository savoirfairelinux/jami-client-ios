...
class RequestsViewModel: ObservableObject {
    ...
    @Published var unreadRequests = 0 {
        didSet {
            unreadRequestsAccessibilityLabel = unreadRequests > 1 ? L10n.Accessibility.pendingRequestsRowPlural("\(unreadRequests)") : L10n.Accessibility.pendingRequestsRowSingle("\(unreadRequests)")
        }
    }
