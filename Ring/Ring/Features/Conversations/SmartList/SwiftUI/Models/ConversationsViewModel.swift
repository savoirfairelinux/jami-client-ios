...
//            return conversationsSource.conversationViewModels
//        } else {
//            return conversationsSource.conversationViewModels.filter { $0.matches(searchQuery) }
//        }
//    }
    ...
    private func setupBindings() {
        // Combine the publishers of searchQuery and conversationViewModels to update filteredConversations
