...
struct SearchableSmartList: View {
    ...
    var body: some View {
        SmartListContainer(model: model, requestsModel: model.requestsModel, mode: mode, isSearchBarActive: $isSearchBarActive, isNewMessageViewPresented: $isNewMessageViewPresented, dismissAction: dismissAction)
