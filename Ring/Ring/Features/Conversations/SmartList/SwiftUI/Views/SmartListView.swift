...
//                            VisualEffect(style: .systemChromeMaterial, withVibrancy: false)
//                                .opacity(opacity)
//                                .ignoresSafeArea(edges: [.top, .bottom])
...
//                Spacer()
//                    .frame(height: 10)
                List(model.accountsRows, id: \.id) { accountRow in
                    AccountRowView(accountRow: accountRow)
                        .listRowBackground(accountRow.id == model.selectedAccount ? Color(UIColor.tertiarySystemGroupedBackground).clipShape(RoundedRectangle(cornerRadius: 3))
           ...
           // .background(Color(UIColor.systemBackground))
           // .background(VisualEffect(style: .systemChromeMaterial, withVibrancy: false))
            // .background(VisualEffect(style: .systemMaterialDark, withVibrancy: true))
           // .cornerRadius(12)
           // .padding(.horizontal, 2)
//            .onAppear {
//                model.getAccountsRows()
//            }
//            HStack {
//                Spacer()
                Button(action: {
