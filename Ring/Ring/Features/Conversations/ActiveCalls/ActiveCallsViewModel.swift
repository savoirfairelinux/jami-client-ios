...
class ActiveCallsViewModel: ObservableObject, Stateable {
    ...
    private func handleActiveCalls(_ accountCalls: [String: ConversationCallState]) {
    ...
    private func getNonLocalCalls(from accountCalls: ConversationCallState) -> [ActiveCall] {
