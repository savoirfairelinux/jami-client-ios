    ...
    fileprivate func search(withText text: String) {
        ...
        let filteredConversations =
            self.dataSource.conversationViewModels
                .filter({conversationViewModel in
                    let valuesToVerify: [String] = [conversationViewModel.userName.value,
                                                    conversationViewModel.displayName.value ?? "",
                                                    conversationViewModel.conversation.value.participantUri,
                                                    conversationViewModel.conversation.value.hash]
                    var matched = false
