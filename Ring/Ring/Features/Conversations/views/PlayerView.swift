...
struct PlayerView: View {
    ...
    private var messageGradient: some View {
        VStack {
            Spacer()
            LinearGradient(
    ...
    private var messagePlayButton: some View {
    ...
    private var messageBottomBar: some View {
        VStack(spacing: 2) {
            Spacer()
            messageDurationRow
            messageSlider
    ...
    private var messageDurationRow: some View {
    ...
    private var messageSlider: some View {
        PlayerSlider(
            value: Binding(
                get: { coordinator.progress },
                set: { coordinator.progress = $0 }
