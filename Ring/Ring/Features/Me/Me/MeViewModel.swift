...
class MeViewModel: ViewModel, Stateable {
    ...
    lazy var connectivitySettings: Observable<SettingsSection> = {
        ...
        return Observable
            .just(.accountSettings( items: self.turnEnabled.value ? [.sectionHeader(title: L10n.AccountPage.connectivityHeader),
                                                                     .turnEnabled,
                                                                     .turnServer,
                                                                     .turnUsername,
                                                                     .turnPassword,
                                                                     .turnRealm] : [.sectionHeader(title: L10n.AccountPage.connectivityHeader),
                                                                                    .turnEnabled]))
    }()
