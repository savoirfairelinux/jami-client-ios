...
class MeViewController: EditProfileViewController, StoryboardBased, ViewModelBased {
    ...
    func configureTurnCell(cellType: SettingsSection.SectionRow,
        ...
        let cell = DisposableCell(style: style, reuseIdentifier: turnCell)
        cell.selectionStyle = .none
...
//        cell.layoutIfNeeded()
//
//        if var detailTextLabelFrame = cell.detailTextLabel?.frame {
//            var origin = detailTextLabelFrame.origin
//            origin = CGPoint(x: origin.x + 15, y: origin.y)
//            detailTextLabelFrame.origin = origin
//            textField.frame = detailTextLabelFrame
//        }
        cell.detailTextLabel?.addSubview(textField)
        cell.sizeToFit()
