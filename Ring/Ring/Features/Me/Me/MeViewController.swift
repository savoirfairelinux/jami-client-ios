...
class MeViewController: EditProfileViewController, StoryboardBased, ViewModelBased {
    ...
    override func viewDidLoad() {
        ...
        self.configureNavigationBar(backgroundColor: .jamiFormBackgroundColor)
...
extension MeViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        if let dataSource = tableView.dataSource as? RxTableViewSectionedReloadDataSource<SettingsSection> {
            let headerTitle = dataSource.titleForHeaderInSection(dataSource, section)
            if headerTitle == nil || headerTitle!.isEmpty {
                return 0.0
            }
        }
        return 30
