...
protocol Coordinator: class {
    ...
    /**
     ...
     - Parameters:
     - injectionBag: The injection Bag that will be passed to every sub components that need it
...
extension Coordinator {
    ...
    /**
     ...
     - Parameters:
     - childCoordinator: The coordinator on which we need to keep a reference
    ...
    /**
     ...
     - Parameters:
     - childCoordinator: The coordinator we want ot remove
