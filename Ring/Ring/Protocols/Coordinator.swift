...
extension Coordinator {
    ...
    func createHostingVC<Content: View>(
        ...
        hostingController.navBarColor = navBarColor
        hostingController.titleColor = titleColor
        hostingController.isTransparent = isTransparent
...
class HostingController<Content>: UIHostingController<Content> where Content: View {
    ...
    private func setNavigationBarAppearance() {
        ...
        if let navBarColor = navBarColor {
            self.configureNavigationBar(isTransparent: isTransparent, backgroundColor: navBarColor)
        } else {
            self.configureNavigationBar(isTransparent: isTransparent)
        }
    }

    private func clearNavigationBarAppearance() {
