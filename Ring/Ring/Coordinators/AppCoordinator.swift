...
class AppCoordinator: Coordinator, StateableResponsive {
    ...
    func start () {
        ...
        self.tabBarViewController.viewControllers = [conversationsCoordinator.rootViewController, contactRequestsCoordinator.rootViewController, meCoordinator.rootViewController, callCoordinator.rootViewController]
        ...
        self.rootViewController.rx.viewDidAppear.take(1).subscribe(onNext: { [unowned self, unowned conversationsCoordinator, unowned meCoordinator] (_) in
