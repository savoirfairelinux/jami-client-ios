...
extension CNContactVCardSerialization {
    ...
    class func dataWithImageAndUUID(from contact: CNContact, andImageCompression compressedSize: Int?) throws -> Data {
        ...
        let firstname = VCardFields.name.rawValue + name + "\n"
        let fullName = VCardFields.fullName.rawValue + name + "\n"
        let endString = VCardFields.end.rawValue

        var vCardString = beginString + entryUID + firstname + fullName + endString
