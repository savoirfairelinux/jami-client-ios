...
extension UIColor {
    ...
    static let jamiButtonLight = UIColor(hexString: "#0071C9")!
    static let jamiButtonDark = UIColor(hexString: "005699")!
    static let jamiButtonWithOpacity = UIColor(hexString: "#005699")!.withAlphaComponent(0.33)
