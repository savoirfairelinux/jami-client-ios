...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func startDaemon() {
        ...
        } catch RINGStartDaemonError.InitializationFailure {
            print("Daemon failed to initialize.")
        } catch RINGStartDaemonError.StartFailure {
            print("Daemon failed to start.")
        } catch RINGStartDaemonError.DaemonAlreadyRunning {
    ...
    fileprivate func stopDaemon() {
        ...
        } catch RINGStopDaemonError.DaemonNotRunning {
