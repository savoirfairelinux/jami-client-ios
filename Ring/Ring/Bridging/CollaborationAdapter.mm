...
- (void)registerConfigurationHandler {
    ...
    confHandlers.insert(exportable_callback<ConversationSignal::CollaborativeDocumentUpdate>(
    ...
    confHandlers.insert(exportable_callback<ConversationSignal::CollaborativeAwarenessChanged>(
        [&](const std::string& accountId,
            const std::string& conversationId,
            const std::string& documentId,
    ...
    confHandlers.insert(exportable_callback<ConversationSignal::CollaborativeParticipantLeft>(
        [&](const std::string& accountId,
            const std::string& conversationId,
            const std::string& documentId,
            const std::string& peerId,
    ...
    confHandlers.insert(exportable_callback<ConversationSignal::CollaborativeDocumentRenamed>(
        [&](const std::string& accountId,
            const std::string& conversationId,
            const std::string& documentId,
    ...
    confHandlers.insert(exportable_callback<ConversationSignal::CollaborativeAttachmentAdded>(
        [&](const std::string& accountId,
            const std::string& conversationId,
            const std::string& documentId,
    ...
    confHandlers.insert(exportable_callback<ConversationSignal::CollaborativeDocumentRemoved>(
        [&](const std::string& accountId,
            const std::string& conversationId,
            const std::string& documentId,
            bool everywhere) {
