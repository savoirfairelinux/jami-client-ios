...
- (uint32_t)loadConversationUntilForAccountId:(NSString*) accountId conversationId:(NSString*) conversationId from:(NSString*)fromMessage toMessage:(NSString*)toMessage;
