...
- (bool)seekToPlayerTime:(NSString*)playerId time:(int)time {
    return DRing::seekToPlayerTime(std::string([playerId UTF8String]), time);
}

-(int)getPlayerPosition:(NSString*)playerId {
