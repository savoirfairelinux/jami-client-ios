...
- (BOOL)enableBoostMode:(NSString *)accountId password:(NSString *)password enable:(BOOL)enable {
    return enableBoostMode(std::string([accountId UTF8String]), std::string([password UTF8String]), enable);
}
