...
private extension View {
    func rosterRowInsets() -> some View {
        padding(.horizontal, RosterMetrics.margin)
...
private struct RosterControlIcon: View {
    ...
    var body: some View {
        Image(systemName: systemImage)
            ...
            .frame(minWidth: RosterMetrics.tapTarget,
                   minHeight: RosterMetrics.tapTarget,
                   alignment: .trailing)
...
struct ConferenceParticipantsView: View {
    ...
    var body: some View {
        ...
        .background(Color.jamiCallBackdrop.ignoresSafeArea())
    }
