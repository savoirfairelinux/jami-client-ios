...
final class ParticipantCanvas: UIView {
    ...
    private func showDockHandle(side: PreviewDockSide) {
    ...
    private func positionDockHandle(side: PreviewDockSide,
        ...
        previewDockHandle.center = CGPoint(x: origin.x + size.width / 2,
