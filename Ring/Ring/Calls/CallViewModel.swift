...
extension CallViewModel {
    ...
    func getItemsForConferenceMenu(participantId: String, callId: String) -> [MenuItem] {
        ...
        return menuItemsManager.getMenuItemsFor(call: isModerator ? call : self.callService.call(callID: callId), isHost: callIsHost, conference: conference, active: active, role: role)
    }
}
