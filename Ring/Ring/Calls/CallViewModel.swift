...
extension CallViewModel {
    ...
    func showConversations() {
        ...
        self.stateSubject.onNext(ConversationState.openConversationForConversationId(conversationId: conversation.id, accountId: conversation.accountId, shouldOpenSmarList: true))
    }
