...
class CallViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    @IBOutlet weak var backgroundBlurEffectWidthConstraint: NSLayoutConstraint!
    @IBOutlet weak var backgroundBlurEffectXConstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        if self.viewModel.isAudioOnly {
            ...
            self.buttonsContainer.stackViewBottomConstraint.constant = 115
        } else {
...
//            self.backgroundBlurEffectWidthConstraint.constant  = -600
            self.buttonsContainer.backgroundBlurEffectLeadingConstraint.constant = 210
            self.buttonsContainer.backgroundBlurEffectTrailingConstraint.constant = 210
            if UIDevice.current.orientation == .landscapeLeft {
                self.capturedVideoTrailingConstraint.constant = 20
                self.callProfileImageLeadingConstraint.constant = 65
//                self.backgroundBlurEffectXConstraint.constant = -250
            } else {
                self.capturedVideoTrailingConstraint.constant = 50
                self.callProfileImageLeadingConstraint.constant = 34
//                self.backgroundBlurEffectXConstraint.constant = -280
            }
        default :
            self.capturedVideoTopConstraint.constant = 17
            self.capturedVideoTrailingConstraint.constant = 17
            self.callProfileImageLeadingConstraint.constant = 35
//            self.backgroundBlurEffectXConstraint.constant = -243
           // self.backgroundBlurEffectWidthConstraint.constant  = -525
            self.buttonsContainer.backgroundBlurEffectLeadingConstraint.constant = 140
            self.buttonsContainer.backgroundBlurEffectTrailingConstraint.constant = 140
        }
        self.buttonsContainer.stackViewWidthConstraint.constant = 340
        self.buttonsContainer.backgroundBlurEffectHeightConstraint.constant = 0
        self.infoContainerHeightConstraint.constant = 105
        self.callProfileImageTopConstraint.constant = 33
        self.callInfoTimerLabelBottomConstraint.constant = -2
        self.callInfoTimerLabelLeadingConstraint.constant = 88
        self.nameLabelYConstraint.constant = 8
        self.buttonsContainer.cancelButtonHeightConstraint.constant = 30
        self.buttonsContainer.stackViewBottomConstraint.constant = 40
        self.backgroundBlurEffect.cornerRadius = 15
        self.backgroundBlurEffectHeightConstraint.constant = 0
        self.backgroundBlurEffectYConstraint.constant = 20
        self.buttonsContainer.backgroundBlurEffectYConstraint.constant = 90
        self.buttonsContainer.backgroundBlurEffect.cornerRadius = 35
    }
    ...
    func setupPortraitConstraints() {
        ...
        case "iPhone X", "iPhone XS", "iPhone XS Max", "iPhone XR" :
            ...
            self.infoContainerHeightConstraint.constant = 212
            self.buttonsContainer.stackViewBottomConstraint.constant = 145
            self.buttonsContainer.cancelButtonHeightConstraint.constant = 55
            self.buttonsContainer.stackViewWidthConstraint.constant = 340
            self.backgroundBlurEffectHeightConstraint.constant = 18
            self.backgroundBlurEffectYConstraint.constant = 0
            self.buttonsContainer.backgroundBlurEffectYConstraint.constant = 0
        default :
            self.capturedVideoTopConstraint.constant = 32
            self.capturedVideoTrailingConstraint.constant = 18
            self.infoContainerHeightConstraint.constant = 204
            self.buttonsContainer.stackViewBottomConstraint.constant = 140
            self.buttonsContainer.cancelButtonHeightConstraint.constant = 50
            self.buttonsContainer.stackViewWidthConstraint.constant = 380
            self.backgroundBlurEffectHeightConstraint.constant = 50
            self.backgroundBlurEffectYConstraint.constant = -20
            self.buttonsContainer.backgroundBlurEffectYConstraint.constant = 20
            self.buttonsContainer.backgroundBlurEffectHeightConstraint.constant = 30
        }
        self.backgroundBlurEffect.cornerRadius = 30
        self.buttonsContainer.backgroundBlurEffect.cornerRadius = 35
        self.buttonsContainer.backgroundBlurEffectLeadingConstraint.constant = 0
        self.buttonsContainer.backgroundBlurEffectTrailingConstraint.constant = 0
       ...
       // self.backgroundBlurEffectWidthConstraint.constant  = 0
        self.backgroundBlurEffectXConstraint.constant = 0
    }
