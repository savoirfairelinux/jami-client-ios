...
class CallViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    @IBOutlet weak var backgroundCapturedVideoWidthConstraint: NSLayoutConstraint!
    @IBOutlet weak var backVideoTrailingConstraint: NSLayoutConstraint!
    @IBOutlet weak var backVideoTopConstraint: NSLayoutConstraint!
    @IBOutlet weak var backVideoWidthConstraint: NSLayoutConstraint!
    @IBOutlet weak var backVideoHeightConstraint: NSLayoutConstraint!
                    ...
                    UIView.animate(withDuration: 0.3, delay: 0.0,
                                   ...
                                   animations: { [unowned self] in
                                    ...
                                    case "iPhone X", "iPhone XS", "iPhone XS Max", "iPhone XR" :
                                        self.backVideoTopConstraint.constant = 40
                                    default :
                                        self.backVideoTopConstraint.constant = 30
                                    }
                                    self.backVideoTrailingConstraint.constant = 10
                                    self.backVideoWidthConstraint.constant = -UIScreen.main.bounds.width + 120
                                    self.backVideoHeightConstraint.constant = -UIScreen.main.bounds.height + 160
                                    self.backgroundCapturedVideo.cornerRadius = 10
                                    self.view.layoutIfNeeded()
                        }, completion: nil)
                }
            }).disposed(by: self.disposeBag)
