...
class CallViewController: UIViewController, StoryboardBased, ViewModelBased, ContactPickerDelegate {
    ...
    func configureIncomingVideView() {
        ...
        videoContainerViewModel = ContainerViewModel(localId: localId, delegate: self, videoService: self.viewModel.videoService, currentCall: self.viewModel.currentCall.share(), audioService: self.viewModel.audioService)
