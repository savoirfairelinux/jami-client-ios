...
class CallModel: Object {
    ...
    dynamic var dateReceived: Date = Date()
    dynamic var fromRingId: String = ""
    dynamic var displayName: String = ""
    dynamic var registeredName: String = ""
    dynamic var accountId: String = ""
    dynamic var audioMuted: Bool = false
    dynamic var videoMuted: Bool = false

    dynamic var stateValue = CallState.unknown.rawValue
    dynamic var callTypeValue = CallType.missed.rawValue

    var state: CallState {
        get {
            return CallState(rawValue: stateValue)!
        }
        set {
    ...
    var callType: CallType {
        get {
            return CallType(rawValue: callTypeValue)!
        }
        set {
    ...
    fileprivate enum CallDetailKey: String {
    ...
    convenience init(withCallId callId: String, valuesFromDictionary dictionary: [String: String]) {
        self.init()
        self.callId = callId
