...
class ContainerViewModel: ObservableObject {
    ...
    init(localId: String, delegate: PictureInPictureManagerDelegate, videoService: VideoService, currentCall: Observable<CallModel>, audioService: AudioService) {
        self.localId = localId
        self.videoService = videoService
        self.actionsViewModel = ActionsViewModel(actionsState: self.actionsStateSubject, currentCall: currentCall, audioService: audioService)
    ...
    func addParticipantInfo(info: ConferenceParticipant) {
        let participant = ParticipantViewModel(id: info.sinkId, videoService: videoService)
        participant.info = info
