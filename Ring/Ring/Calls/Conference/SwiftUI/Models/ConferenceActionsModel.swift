...
class ConferenceActionsModel {
    ...
    func endParticipant(participantId: String, device: String, conferenceId: String) {
        self.callService.endParticipant(confId: conferenceId, participantId: participantId, device: device)
    }
