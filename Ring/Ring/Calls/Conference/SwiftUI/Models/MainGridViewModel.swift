...
struct Page {
    ...
    init(columns: Int, rows: Int) {
        ...
        self.width = (UIScreen.main.bounds.width - marginHorizontal) / CGFloat(columns)
        self.height = (UIScreen.main.bounds.height - marginVertical) / CGFloat(rows)
    }
}
