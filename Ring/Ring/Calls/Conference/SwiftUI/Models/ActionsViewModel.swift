...
enum ParticipantAction: State {
    ...
    var defaultButtonInfo: ButtonInfo {
        switch self {
        case .hangup:
            return ButtonInfo(background: .clear, stroke: .clear, name: "slash.circle", action: self)
        case .minimize:
            return ButtonInfo(background: .clear, stroke: .white, name: "arrow.down.right.and.arrow.up.left", action: self)
        case .maximize:
            return ButtonInfo(background: .clear, stroke: .white, name: "arrow.up.left.and.arrow.down.right", action: self)
        case .setModerator:
            return ButtonInfo(background: .clear, stroke: .white, name: "crown", action: self)
        case .muteAudio:
            return ButtonInfo(background: .clear, stroke: .clear, name: "mic", action: self)
        case .raseHand:
    ...
    var alterButtonInfo: ButtonInfo {
        ...
        case .minimize:
            return ButtonInfo(background: .clear, stroke: .white, name: "arrow.down.right.and.arrow.up.left", action: self)
        case .maximize:
            return ButtonInfo(background: .secondary, stroke: .white, name: "arrow.up.left.and.arrow.down.right", action: self)
        case .setModerator:
            return ButtonInfo(background: .secondary, stroke: .white, name: "crown", action: self)
        case .muteAudio:
            return ButtonInfo(background: .secondary, stroke: .red, name: "mic.slash", action: self)
        case .raseHand:
            return ButtonInfo(background: .secondary, stroke: .white, name: "hand.raised", action: self)
        }
    }
}

struct ParticipantActions {
    let hangupButton: ButtonInfoWrapper
    let minimizeButton: ButtonInfoWrapper
    let maximizeButton: ButtonInfoWrapper
    let setModeratorButton: ButtonInfoWrapper
    let muteAudioButton: ButtonInfoWrapper
    let raseHandButton: ButtonInfoWrapper
}
