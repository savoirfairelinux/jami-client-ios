...
struct ParticipantActionsView: View {
    ...
    var body: some View {
        ScrollView(.horizontal) {
            LazyHStack {
                ForEach(participant.conferenceActions, id: \.name) { button in
                    Button(action: {
