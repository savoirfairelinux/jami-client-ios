...
struct PulsatingAvatarView: View {
    ...
    var body: some View {
        ZStack {
            ...
            AvatarSwiftUIView(source: participant.avatarProvider(for: Constants.AvatarSize.xLarge.points))
        }
...
struct ContainerView: View {
    ...
    var body: some View {
        ...
        .onChange(of: dimensionsManager.isLandscape) { _ in
            audioCallViewIdentifier = dimensionsManager.isLandscape ? "audioCallView_landscape" : "audioCallView_portrait"
        }
    }
    ...
    func initialVideoCallView() -> some View {
        ...
        .frame(maxWidth: dimensionsManager.adaptiveWidth, maxHeight: dimensionsManager.adaptiveHeight)
        .ignoresSafeArea()
    }
