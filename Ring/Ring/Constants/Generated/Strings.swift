...
internal enum L10n {
  ...
  internal enum LinkDevice {
    ...
    /// An error happens while generating token.
    /// Please try again.
    internal static let errorToken = L10n.tr("Localizable", "linkDevice.errorToken", fallback: "An error happens while generating token.\nPlease try again.")
    /// An error happens while exporting account.n
    /// Please try again.
    internal static let errorWrongData = L10n.tr("Localizable", "linkDevice.errorWrongData", fallback: "An error happens while exporting account.n\nPlease try again.")
    /// Password incorrect.
