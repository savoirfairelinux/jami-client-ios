...
internal enum L10n {
  ...
  internal enum AccountPage {
    ...
    internal static let conenctivityAndConfiguration = L10n.tr("Localizable", "accountPage.conenctivityAndConfiguration", fallback: "Connectivity & configurations")
    /// Connectivity
    ...
    /// Select time (in seconds) for registration expiration
    internal static let editSipExpirationTime = L10n.tr("Localizable", "accountPage.editSipExpirationTime", fallback: "Select time (in seconds) for registration expiration")
    /// Enable Booth Mode
    ...
    /// Notifications for Jami are disabled. Please enable them in your
    internal static let notificationErrorPart1 = L10n.tr("Localizable", "accountPage.notificationErrorPart1", fallback: "Notifications for Jami are disabled. Please enable them in your")
    /// device settings
    internal static let notificationErrorPart2 = L10n.tr("Localizable", "accountPage.notificationErrorPart2", fallback: "device settings")
    /// Notifications
    ...
    /// This account is password encrypted, enter a password to genrate PIN code
    internal static let passwordForPin = L10n.tr("Localizable", "accountPage.passwordForPin", fallback: "This account is password encrypted, enter a password to genrate PIN code")
    ...
    /// Register a username to help others more easily to find and reach you on Jami.
    internal static let registerNameExplanation = L10n.tr("Localizable", "accountPage.registerNameExplanation", fallback: "Register a username to help others more easily to find and reach you on Jami.")
    ...
    /// Remove device
    internal static let revokeDeviceTitle = L10n.tr("Localizable", "accountPage.revokeDeviceTitle", fallback: "Remove device")
    /// Security
    internal static let security = L10n.tr("Localizable", "accountPage.security", fallback: "Security")
    /// Select time (in seconds) for registration expiration
    internal static let selectSipExpirationTime = L10n.tr("Localizable", "accountPage.selectSipExpirationTime", fallback: "Select time (in seconds) for registration expiration")
    /// Settings
    ...
    /// Requere certificate for incoming TLS connections
    internal static let tlsRequereTlsCertificate = L10n.tr("Localizable", "accountPage.tlsRequereTlsCertificate", fallback: "Requere certificate for incoming TLS connections")
