...
internal enum L10n {
  ...
  internal enum AccountPage {
    ...
    internal static let notificatioerrorPart1 = L10n.tr("Localizable", "accountPage.notificatioerrorPart1", fallback: "Notifications for Jami are disabled. Please enable them in your")
    /// device settings
    internal static let notificatioerrorPart2 = L10n.tr("Localizable", "accountPage.notificatioerrorPart2", fallback: "device settings")
    /// Notifications
