...
internal enum L10n {
  ...
  internal enum Conversation {
    ...
    /// An error occurred while saving the image to the photo library. Please try again.
    internal static let errorSavingImageMessage = L10n.tr("Localizable", "conversation.errorSavingImageMessage", fallback: "An error occurred while saving the image to the photo library. Please try again.")
    /// Saved
