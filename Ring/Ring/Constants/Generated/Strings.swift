...
internal enum L10n {
  ...
  internal enum ShareExtension {
    /// Double tap to open account selection
    internal static let accessibilityOpenAccountSelection = L10n.tr("Localizable", "shareExtension.accessibilityOpenAccountSelection", fallback: "Double tap to open account selection")
    ...
    /// Selected account: %@. Tap to change account.
    internal static func accessibilitySelectedAccount(_ p1: Any) -> String {
      return L10n.tr("Localizable", "shareExtension.accessibilitySelectedAccount", String(describing: p1), fallback: "Selected account: %@. Tap to change account.")
    }
