...
internal enum L10n {
  ...
  internal enum Accessibility {
    ...
    internal static func pendingRequestsRowSingle(_ p1: Any) -> String {
      return L10n.tr("Localizable", "accessibility.pendingRequestsRowSingle", String(describing: p1), fallback: "Invitation received: %@ pending invitation")
    }
    /// Profile picture
