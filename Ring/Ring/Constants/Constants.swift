...
public class Constants: NSObject {
    ...
    @objc public static let notificationShareExtensionQuery = "com.savoirfairelinux.shareExtension.accountQuery" as CFString
    @objc public static let notificationShareExtensionResponse = "com.savoirfairelinux.shareExtension.accountActive" as CFString
    @objc public static let notificationExtensionQuery = "com.savoirfairelinux.notificationExtension.accountQuery" as CFString
