        ...
        self.callService
            ...
            .subscribe(onNext: { [weak self] callEvent in
                ...
                if account.type != .sip {
                    ...
                    guard let conversation = self.conversationService.getConversationForParticipant(jamiId: jamiId.filterOutHost(), accountId: accountID), !conversation.shouldUseSwarmConversationPath() else { return }
                } else {
