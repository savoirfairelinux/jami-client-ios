...
class GeneratedInteractionsManager {
    ...
    private func removeConversation(accountId: String,
        ...
        self.conversationService.clearDbHistory(conversation: conversation, keepConversation: false)
    }
        ...
        self.callService
            ...
            .subscribe(onNext: { [weak self] callEvent in
                ...
                if account.type != .sip {
                    ...
                    guard let conversation = self.conversationService.getConversationForParticipant(jamiId: jamiId.filterOutHost(), accontId: accountID), conversation.type == .nonSwarm else { return }
                } else {
