    ...
    private func subscribeFileTransferEvents() {
        self.dataTransferService
            ...
            .subscribe(onNext: { [weak self] event in
                ...
                guard let transferInfo = self.dataTransferService.dataTransferInfo(withId: transferId, accountId: accountId, conversationId: conversationId, isSwarm: !conversationId.isEmpty),
    ...
    func newInteraction(conversationId: String, accountId: String, message: [String: String]) {
        ...
        if let fileId = message[MessageAttributes.fileId.rawValue], !fileId.isEmpty {
           // if let transferInfo = self.dataTransferService.dataTransferInfoNew(withId: fileId, accountId: accountId, conversationId: conversationId) {
            ...
            var filename = ""
            self.dataTransferService.downloadFile(withId: fileId, interactionID: newMessage.messageId, fileName: &filename, accountID: accountId, conversationID: conversationId)
