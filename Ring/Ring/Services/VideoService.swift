...
//         withWidth width: Int32,
//         withHeight height: Int32,
//         withRate rate: Double) {
//        self.name = name
//        self.width = width
//        self.height = height
//        self.rate = rate
...
class FrameExtractor: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func switchCameraTapped(sender: Any) -> Completable {
...
class VideoService {
    ...
    func bindSinkFunctions() {
        videoAdapter.bindSinkFunctions()
    }
    ...
    func enumerateVideoInputDevices() {
        do {
            ...
            self.log.error("Unkonw error configuring capture device")
        }
    }
