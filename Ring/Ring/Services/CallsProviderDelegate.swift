...
extension CallsProviderDelegate {
    ...
    private func reportIncomingCall(account: AccountModel, call: CallModel,
        ...
        self.setUpCallUpdate(update: update, localizedCallerName: handleInfo.displayName, flag: !call.isAudioOnly)
    ...
    func updateRegisteredName(account: AccountModel, call: CallModel) {
        ...
        update.remoteHandle = CXHandle(type: handleType, value: handleInfo.handle)
        self.setUpCallUpdate(update: update, localizedCallerName: call.registeredName, flag: !call.isAudioOnly)
    ...
    func previewPendingCall(peerId: String, withVideo: Bool, displayName: String,
        ...
        self.setUpCallUpdate(update: update, localizedCallerName: displayName, flag: withVideo)
    ...
    func setUpCallUpdate(update: CXCallUpdate, localizedCallerName: String, flag: Bool) {
