...
class ContactRequestManager {
        ...
        self.contactService
            ...
            .subscribe(onNext: { [unowned self] contactRequestEvent in
                ...
                case ServiceEventType.contactRequestDiscarded:
                    self.removeConversation(accountId: account.id, accountRingId: ringId, contactRingId: contactRingId,
    ...
    private func removeConversation(accountId: String, accountRingId: String, contactRingId: String,
