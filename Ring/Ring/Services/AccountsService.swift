...
class AccountsService: AccountAdapterDelegate {
    ...
    func setTurnSettings(accountId: String, server: String, username: String, password: String, realm: String) {
        let details = self.accountService.getAccountDetails(fromAccountId: accountId)
        ...
        self.accountService.setAccountDetails(forAccountId: accountId, withDetails: details)
    }
