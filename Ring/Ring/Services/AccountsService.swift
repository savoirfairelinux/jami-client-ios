...
class AccountsService: AccountAdapterDelegate {
    ...
    func addRingAccount(withUsername username: String?, password: String) throws {
        do {
            ...
            if account == nil {
                ...
                let volatileDetails = self.getAccountVolatilesDetails(fromAccountId: accountId!)
    ...
    func getAccountVolatilesDetails(fromAccountId id: String) -> Dictionary<String, String> {
