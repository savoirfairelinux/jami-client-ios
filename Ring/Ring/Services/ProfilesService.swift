...
/// - Avatars are decoded at least at `primarySize * 2` points (to match Retina scaling and keep quality),
///   even if the UI asks for a smaller size. See `AvatarProvider.subscribeAvatar` for the `max(size * 2, primarySize * 2)` logic.
