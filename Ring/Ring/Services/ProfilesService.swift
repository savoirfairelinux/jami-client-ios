...
protocol InvitationProfileProviding: AnyObject {
...
class ProfilesService {
    ...
    private weak var invitations: InvitationProfileProviding?
    ...
    init(withProfilesAdapter adapter: ProfilesAdapter,
         ...
         invitations: InvitationProfileProviding? = nil) {
    ...
    func invitationReceived(uri: String, accountId: String) {
        triggerProfileSignal(uri: uri, accountId: accountId)
    }
    ...
    private func invitationProfile(for key: ProfileKey) -> Profile? {
        invitations?.invitationProfile(forURI: key.uri, accountId: key.accountId)
