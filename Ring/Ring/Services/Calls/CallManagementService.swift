...
class CallManagementService {
    ...
    func createSwarmCallModel(conference: (confId: String, conversationId: String, accountId: String)) -> CallModel {
        let call = CallModel()
        ...
        if let callDictionary = getCallDetails(callId: call.callId, accountId: conference.accountId) {
    ...
    func addOrUpdateCall(callId: String, callState: CallState, callDictionary: [String: String], mediaList: [[String: String]] = [[String: String]](), notifyIncoming: Bool = false) -> CallModel? {
        ...
        if let call = call, notifyIncoming {
