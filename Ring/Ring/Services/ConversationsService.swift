...
class ConversationsService {
    ...
    func messageUpdated(conversationId: String, accountId: String, message: SwarmMessageWrap, accountJamiId: String) {
        guard let conversation = self.getConversationForId(conversationId: conversationId, accountId: accountId) else { return }
        conversation.messageUpdated(swarmMessage: message, accountJamiId: accountJamiId)
    }
