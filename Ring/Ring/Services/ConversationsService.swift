...
class ConversationsService {
    ...
    func makeEventSource(onEvent: @escaping (ConversationEvent) -> Void) -> ConversationEventSource {
        return ConversationEventSource(queue: serialOperationQueue, onEvent: onEvent)
    }
