...
class ContactViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let titleView = TitleView(frame: CGRect(x: 0, y: 0, width: 200, height: 80))
        let data = self.viewModel.profileImageData.value
        titleView.data = AvatarView(profileImageData: data, username: "Kateryna", size: 40)
        titleView.text = "Kateryna"
