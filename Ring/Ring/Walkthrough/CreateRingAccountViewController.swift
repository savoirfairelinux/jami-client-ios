...
class CreateRingAccountViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if currentCellType == .registerPublicUsername {
            ...
            //Binds switch state to showUsernameField
            _ = cell.registerSwitch.rx.value.bindTo(self.mAccountViewModel.showUsernameField)
                .addDisposableTo(mDisposeBag)
            ...
            let hideErrorMessage = Observable<Bool>
                .combineLatest(self.mAccountViewModel.passwordValid, textFieldNotEmpty)
                { isPasswordValid, textFieldNotEmpty in
