...
class MessageActions: Identifiable, Equatable, Hashable {
    var id: String = ""
    var author: String = ""
    var content: String = ""
    ...
    static func == (lhs: MessageActions, rhs: MessageActions) -> Bool {
...
public class MessageModel {
    ...
    var totalSize: Int = 0
    var parents = [String]()
    var reactions = Set<MessageActions>()
    var editions = Set<MessageActions>()
    ...
    convenience init (with swarmMessage: SwarmMessageWrap, accountJamiId: String) {
        ...
        for reaction in swarmMessage.reactions {
            self.reactions.insert(MessageActions(withInfo: reaction))
        }
        for edition in swarmMessage.editions {
            self.editions.insert(MessageActions(withInfo: edition))
        }
    }
    ...
    func messageUpdated(message: SwarmMessageWrap) {
        self.editions = Set<MessageActions>()
        self.reactions = Set<MessageActions>()
