 ...
 *
 * Angle brackets are escaped wherever they fall: markdown carries HTML through
 * untouched, so a tag a peer typed as prose would run in whatever opens the
 * file, and <javascript:...> would come out an autolink.
 *
