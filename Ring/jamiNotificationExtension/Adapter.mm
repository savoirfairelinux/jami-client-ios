...
//        reloadConversationsAndRequests(std::string([accountId UTF8String]), "da3296f8ad1356c6835cf6c59dddcd91fade70b2");
       ...
       // return true;
        auto success = start({}, "e0083e4590ecbf7c", "2388cd3cf4d561600aeadd685f9d0082db475d4a");
        return success;
    }
#if DEBUG
    ...
    if (![[NSThread currentThread] isMainThread]) {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            if (init(static_cast<InitFlag>(flag))) {
                success = start({}, "e0083e4590ecbf7c", "2388cd3cf4d561600aeadd685f9d0082db475d4a");
            } else {
                success = false;
            }
        });
        ...
        if (init(static_cast<InitFlag>(flag))) {
            return start({}, "e0083e4590ecbf7c", "2388cd3cf4d561600aeadd685f9d0082db475d4a");
        }
        return false;
    }
}
