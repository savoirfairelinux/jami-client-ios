...
class NotificationService: UNNotificationServiceExtension {
    ...
    private func conversationUpdated(conversationId: String, accountId: String) {
        ...
        self.setUpdatedConversations(conversations: conversationData)
    }

    private func setUpdatedConversations(conversations: [String: String]) {
        /*
        ...
        conversationData.append(conversations)
