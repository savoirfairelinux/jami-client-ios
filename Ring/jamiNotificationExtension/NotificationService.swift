...
class NotificationService: UNNotificationServiceExtension {
    ...
    private func finish() {
        ...
        // Ship logs BEFORE signaling completion to iOS. The extension
        // process can be killed at any time after contentHandler returns,
        // so the HTTP POST must finish first. The 5-second timeout
        // prevents hanging if the collector is unreachable.
