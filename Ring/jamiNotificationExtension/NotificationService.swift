...
class NotificationService: UNNotificationServiceExtension {
    ...
    private func appIsActive() -> Bool {
        ...
        group.enter()
        // Post darwin notification and wait for the answer from the main app. If answer is received, the app is active.
        ...
        // Wait for 300 milliseconds. If no answer from main app is received, the app is inactive.
