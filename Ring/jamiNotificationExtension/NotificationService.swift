...
class NotificationService: UNNotificationServiceExtension {
    ...
    override func didReceive(_ request: UNNotificationRequest, withContentHandler contentHandler: @escaping (UNNotificationContent) -> Void) {
        print("received notification \(self)")
                ...
                do {
                    ...
                    case .call:
                        ...
                        if #available(iOSApplicationExtension 14.5, *) {
                            CXProvider.reportNewIncomingVoIPPushPayload(request.content.userInfo, completion: { error in
    ...
    func saveData(data: [String: String]) {
        ...
        userDefaults.set(data, forKey: NotificationService.notificationData)
    }
