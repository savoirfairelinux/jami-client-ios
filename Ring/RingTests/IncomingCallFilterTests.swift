...
final class IncomingCallFilterTests: XCTestCase {
    ...
    func testParseAllowFromUnknown_NilValueRejects() {
        XCTAssertFalse(IncomingCallFilter.parseAllowFromUnknown(value: nil))
    }

    func testParseAllowFromUnknown_TrueStringAllows() {
        XCTAssertTrue(IncomingCallFilter.parseAllowFromUnknown(value: "true"))
    }

    func testParseAllowFromUnknown_FalseStringRejects() {
        XCTAssertFalse(IncomingCallFilter.parseAllowFromUnknown(value: "false"))
    }

    func testParseAllowFromUnknown_NonCanonicalCaseRejects() {
        XCTAssertFalse(IncomingCallFilter.parseAllowFromUnknown(value: "TRUE"))
    }
}
