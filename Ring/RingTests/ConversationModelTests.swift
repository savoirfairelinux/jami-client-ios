...
final class ConversationModelTests: XCTestCase {
    ...
    func testUnreadMessages_TypeAssignedAfterInit_SubscribesForNonSwarmConversation() {
        // Arrange
        let uri = JamiURI.init(schema: URIType.ring, infoHash: jamiId1)
        let conversation = ConversationModel(withParticipantUri: uri, accountId: accountId1)
        let message = MessageModel(withId: "message-id",
                                   receivedDate: Date(),
                                   content: "message",
                                   authorURI: jamiId1,
                                   incoming: true)
        ...
        // Assert
        XCTAssertEqual(conversation.numberOfUnreadMessages.value, 1)
    }
    ...
    func testShouldUseSwarmConversationPath_UnclassifiedConversation_ReturnsTrue() {
        // Arrange
        let conversation = createConversation(conversationId: conversationId1, jamiId: jamiId1, type: nil, accountId: accountId1)
        // Act
        let result = conversation.shouldUseSwarmConversationPath()
        // Assert
        XCTAssertTrue(result)
    }
    ...
    func testMatchesTemporaryCoreDialog_UnclassifiedRealConversation_ReturnsTrue() {
        // Arrange
        let temporaryConversation = createConversation(conversationId: "", jamiId: jamiId1, type: .oneToOne, accountId: accountId1)
        let realConversation = createConversation(conversationId: conversationId1, jamiId: jamiId1, type: nil, accountId: accountId1)
        // Act
        let result = temporaryConversation.matchesTemporaryCoreDialog(conversation: realConversation)
        // Assert
        XCTAssertTrue(result)
    }

    func testMatchesTemporaryCoreDialog_DifferentAccount_ReturnsFalse() {
        // Arrange
        let temporaryConversation = createConversation(conversationId: "", jamiId: jamiId1, type: .oneToOne, accountId: accountId1)
        let realConversation = createConversation(conversationId: conversationId1, jamiId: jamiId1, type: nil, accountId: accountId2)
        // Act
        let result = temporaryConversation.matchesTemporaryCoreDialog(conversation: realConversation)
        // Assert
        XCTAssertFalse(result)
    ...
    func testMatchesTemporaryCoreDialog_DifferentParticipant_ReturnsFalse() {
        // Arrange
        let temporaryConversation = createConversation(conversationId: "", jamiId: jamiId1, type: .oneToOne, accountId: accountId1)
        let realConversation = createConversation(conversationId: conversationId1, jamiId: jamiId2, type: nil, accountId: accountId1)
        // Act
        let result = temporaryConversation.matchesTemporaryCoreDialog(conversation: realConversation)
        // Assert
        XCTAssertFalse(result)
    ...
    func testMatchesTemporaryCoreDialog_ClassifiedTemporaryStillMatchesRealCoreDialog() {
        // Arrange
        let temporaryConversation = createConversation(conversationId: "", jamiId: jamiId1, type: .oneToOne, accountId: accountId1)
        let realConversation = createConversation(conversationId: conversationId1, jamiId: jamiId1, type: .oneToOne, accountId: accountId1)
        // Act
        let result = temporaryConversation.matchesTemporaryCoreDialog(conversation: realConversation)
        // Assert
        XCTAssertTrue(result)
