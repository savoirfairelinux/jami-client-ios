...
@property (nonatomic, assign) NSInteger disconnectConferenceCallCount;
@property (nonatomic, copy, nullable) NSString *disconnectConferenceCallId;
@property (nonatomic, copy, nullable) NSString *disconnectConferenceAccountId;
@property (nonatomic, assign) BOOL disconnectConferenceReturnValue;
...
@property (nonatomic, assign) NSInteger disconnectConferenceParticipantCallCount;
@property (nonatomic, copy, nullable) NSString *disconnectConferenceParticipantParticipantId;
@property (nonatomic, copy, nullable) NSString *disconnectConferenceParticipantConferenceId;
@property (nonatomic, copy, nullable) NSString *disconnectConferenceParticipantAccountId;
@property (nonatomic, copy, nullable) NSString *disconnectConferenceParticipantDeviceId;
