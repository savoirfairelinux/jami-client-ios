...
class PeerSharingServiceTests: XCTestCase {
    ...
    private let testPeerId = "jami:peer-001"
    ...
    func testTunnelLifecycle_PendingToActiveToClosedCleansUp() {
        ...
        service.observeTunnelState(accountId: testAccountId, peerId: testPeerId)
        ...
        service.openTunnel(accountId: testAccountId, peerId: testPeerId, service: testService)
