...
final class JamiSearchViewModelTests: XCTestCase {
    ...
    func createSipAccountWithStaleCachedType() -> AccountModel {
    ...
    func testSearch_SipAccountWithStaleCachedType_CreatesSipTemporaryConversation() {
        // Arrange
        let account = createSipAccountWithStaleCachedType()
        ...
        XCTAssertEqual(temporaryConversation?.conversation.type, .sip)
