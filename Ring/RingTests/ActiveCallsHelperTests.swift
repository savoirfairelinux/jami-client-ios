...
final class ActiveCallsHelperTests: XCTestCase {
    ...
    func testActiveCallsChanged_WithEmptyCalls_ClearsIgnoredCalls() {
        ...
        activeCallsHelper.updateActiveCalls(conversationId: conversationId, accountId: accountId, calls: [], account: account)
    ...
    func testActiveCallsChanged_UpdatesMultipleConversations() {
        ...
        activeCallsHelper.updateActiveCalls(conversationId: conversationId1, accountId: accountId, calls: [["id": "call1", "uri": "uri1", "device": "device1"]], account: account)
        activeCallsHelper.updateActiveCalls(conversationId: conversationId2, accountId: accountId, calls: [["id": "call2", "uri": "uri2", "device": "device2"]], account: account)
    ...
    func testActiveCallsChanged_UpdatesMultipleAccounts() {
        ...
        activeCallsHelper.updateActiveCalls(conversationId: conversationId, accountId: accountId1, calls: [["id": "call1", "uri": "uri1", "device": "device1"]], account: account1)
        activeCallsHelper.updateActiveCalls(conversationId: conversationId, accountId: accountId2, calls: [["id": "call2", "uri": "uri2", "device": "device2"]], account: account2)
