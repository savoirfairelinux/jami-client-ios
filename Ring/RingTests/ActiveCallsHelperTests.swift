...
final class ActiveCallsHelperTests: XCTestCase {
    ...
    func testActiveCallsChanged_WithValidCalls_UpdatesCallsCorrectly() {
        ...
        // When
        activeCallsHelper.activeCallsChanged(conversationId: conversationId, accountId: accountId, calls: calls)
    ...
    func testActiveCallsChanged_WithEmptyCalls_ClearsIgnoredCalls() {
        ...
        let accountId = "account1"
        let conversationId = "conv1"
        let call = ActiveCall(id: "call1", uri: "uri1", device: "device1", conversationId: conversationId, accountId: accountId)
        
        // When
        activeCallsHelper.ignoreCall(call)
        activeCallsHelper.activeCallsChanged(conversationId: conversationId, accountId: accountId, calls: [])
    ...
    func testActiveCallsChanged_UpdatesMultipleConversations() {
        ...
        // When
        activeCallsHelper.activeCallsChanged(conversationId: conversationId1, accountId: accountId, calls: [["id": "call1", "uri": "uri1", "device": "device1"]])
        activeCallsHelper.activeCallsChanged(conversationId: conversationId2, accountId: accountId, calls: [["id": "call2", "uri": "uri2", "device": "device2"]])
    ...
    func testActiveCallsChanged_UpdatesMultipleAccounts() {
        ...
        // When
        activeCallsHelper.activeCallsChanged(conversationId: conversationId, accountId: accountId1, calls: [["id": "call1", "uri": "uri1", "device": "device1"]])
        activeCallsHelper.activeCallsChanged(conversationId: conversationId, accountId: accountId2, calls: [["id": "call2", "uri": "uri2", "device": "device2"]])
