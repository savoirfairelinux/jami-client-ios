...
public enum NotificationTesting {
    ...
    public enum Event: String {
        ...
        // Receiver main-app push handlers — fire when iOS delivers the push
        // directly to the foreground app (skipping the notification extension).
        case pushReceivedInApp
